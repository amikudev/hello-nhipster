...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'hellonhipster';
    ...
    'jhipster.mail.from' = 'hellonhipster@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'hellonhipster API';
    'jhipster.swagger.description' = 'hellonhipster API documentation';
    ...
    'eureka.instance.appname' = 'hellonhipster';
    'eureka.instance.instanceId' = 'hellonhipster:${random.value}';
    ...
    'cloud.config.name' = 'hellonhipster';
